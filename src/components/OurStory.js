...
const OurStory = () => {
    const dates = [
        ...
        {date: 'June 2020', title: 'We hiked our first (4!) 14ers together!', description: 'Though we had each hiked 14ers before, on June 20th 2020 we set out to hike our first 14er (peaks in CO that summit above 14,000ft elevation) together. That day we ended up summiting 4 peaks and later that summer we added 2 more to the completed list. 6 down, a lot to go!', imagePath: Fourteener},
